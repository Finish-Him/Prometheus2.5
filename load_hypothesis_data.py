...
try:
    ...
    print(f"Dados de {len(matches_data)} partidas carregados com sucesso para teste de hipóteses.")
...
# Este script apenas carrega os dados. O teste de hipóteses será feito em outro script.
# Para simplificar, o próximo script irá incluir este carregamento.
print("Dados prontos para serem usados no script de teste de hipóteses.")
