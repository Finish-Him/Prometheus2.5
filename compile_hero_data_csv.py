...
output_csv_file = "/home/ubuntu/pgl_wallachia_s4_hero_stats.csv"
...
for hero_id_str, stats in hero_stats.items():
    ...
    if picks > 0:
        ...
        hero_data_list.append({
            ...
            'Avg XPM': round(stats.get('total_xpm', 0) / picks, 1) if picks > 0 else 0, # Recalculate Avg XPM
...
# Salvar em CSV
print(f"Salvando dados compilados em CSV: {output_csv_file}")
try:
